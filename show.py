...
def main():
    ...
    matched_zeroes = utils.match_closest(torch.view_as_real(utils.polar_to_complex(predicted_zeroes)), factual_zeroes)
...
#    logging.info("=" * 50)
    ...
    poly_graphics.show(
        ...
        utils.polar_to_complex(predicted_zeroes[0]).tolist(),
        args.logarithmic
    )
